...
export default function CreateOrganizationForm() {
  ...
  const { data: org } = useGetSingleOrgQuery(profile?.data?._id as string, {
  ...
  const onSubmit = async (data: IOrgForm) => {
    ...
    const newOrgData = { ...data, logo: logoUrl || org.data.logo };
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="description"
                    defaultValue={org.data.description}
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      defaultValue={org.data.address.street}
                      id="street"
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      defaultValue={org.data.address.city}
                      id="city"
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="state"
                      defaultValue={org.data.address.state}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="zip"
                      defaultValue={org.data.address.zip}
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      id="phone"
                      defaultValue={org.data.contactInfo.phone}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="email"
                      type="email"
                      defaultValue={org.data.contactInfo.email}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="website"
                      defaultValue={org.data.contactInfo.website}
                      type="url"
              ...
              <div className="space-y-4">
                ...
                {prevLogo && (
                  <div className="mt-4 relative group w-fit border rounded-lg p-1 flex">
                    <Image
                      src={prevLogo}
                      alt="Logo preview"
                      width={100}
